  ...
  return (
    ...
    >
      {!summary ? (
        ...
        <p className="text-sm text-foreground-muted">No insider trades, bulk/block deals, concalls, or corporate events recorded today.</p>
      ) : (
        <p className="text-sm text-foreground-muted">{parts.join(" · ")} today.</p>
      )}
