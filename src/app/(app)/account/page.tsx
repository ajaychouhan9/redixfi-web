...
// RedixFi AI chat UI session (2026-09-11) — the old "Confirm before sending
// detailed questions" toggle is GONE. It existed only to opt out of the
// retired weighted-credit confirm dialog (a long question used to consume
// 2-3 of the daily allowance). The backend now charges exactly ONE question
// per processed question, so there is no longer anything to confirm and no
// setting to expose. The server-side preference field is left untouched.
